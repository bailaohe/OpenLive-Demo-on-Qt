...
void EnterRoom::on_rbCamera_stateChanged(int arg1)
{
    if(arg1 == Qt::Unchecked)
        CAgoraObject::getInstance()->MuteLocalVideo(XM_FALSE);
    else if(arg1 == Qt::Checked)
        CAgoraObject::getInstance()->MuteLocalVideo(XM_TRUE);
}

void EnterRoom::on_rbMic_stateChanged(int arg1)
{
    if(arg1 == Qt::Unchecked)
        CAgoraObject::getInstance()->MuteLocalAudio(XM_FALSE);
    else if(arg1 == Qt::Checked)
        CAgoraObject::getInstance()->MuteLocalAudio(XM_TRUE);
}
