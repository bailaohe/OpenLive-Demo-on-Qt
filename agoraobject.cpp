...
XM_BOOL CAgoraObject::LocalVideoPreview(XM_HWND hVideoWnd, XM_BOOL bPreviewOn, RENDER_MODE_TYPE renderType/* = RENDER_MODE_TYPE::RENDER_MODE_FIT*/)
{
    int nRet = 0;
    ...
    return nRet == 0 ? XM_TRUE : XM_FALSE;
}

XM_BOOL CAgoraObject::RemoteVideoRender(uid_t uid, XM_HWND hVideoWnd, RENDER_MODE_TYPE renderType/* = RENDER_MODE_TYPE::RENDER_MODE_HIDDEN*/)
{
    int nRet = 0;
...
XM_BOOL CAgoraObject::setLogPath(const QString &strDir)
{
    int ret = 0;
    ...
    return ret == 0 ? XM_TRUE : XM_FALSE;
}

XM_BOOL CAgoraObject::SetChannelProfile(CHANNEL_PROFILE_TYPE channelType)
{
    int ret = 0;
...
XM_BOOL CAgoraObject::SetClientRole(CLIENT_ROLE_TYPE roleType)
{
    int ret = 0;
...
XM_BOOL CAgoraObject::EnableWebSdkInteroperability(XM_BOOL bEnable)
{
    RtcEngineParameters rep(*m_rtcEngine);
...
XM_BOOL CAgoraObject::setVideoProfile(int nWidth,int nHeight)
{
    int res = 0;
    ...
    return res ==0 ? XM_TRUE : XM_FALSE;
}

XM_BOOL CAgoraObject::setRecordingIndex(int nIndex)
{
    int res = 0;
    AAudioDeviceManager audioDeviceManager(m_rtcEngine);
    if (!audioDeviceManager)
...
XM_BOOL CAgoraObject::setPlayoutIndex(int nIndex)
{
    int res = 0;
    AAudioDeviceManager audioDeviceManager(m_rtcEngine);
    if (!audioDeviceManager)
...
XM_BOOL CAgoraObject::setVideoIndex(int nIndex)
{
    int res = 0;
    AVideoDeviceManager videoDeviceManager(m_rtcEngine);
...
XM_BOOL CAgoraObject::MuteLocalVideo(XM_BOOL bMute)
{
     int nRet = 0;
...
XM_BOOL CAgoraObject::MuteLocalAudio(XM_BOOL bMute)
{
    int nRet = 0;
